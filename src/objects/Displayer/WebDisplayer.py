...
# Créer une instance de WebApp
web_app = WebApp(update_interval=1)

# Afficher "blabla" en une seule ligne et démarrer l'application
web_app.show("blabla")

# Mettre à jour la chaîne avec "bloblo" et "blublu"
web_app.show("bloblo")
web_app.show("blublu")
"""